...
See [Custom Pivot Points/Bones](/emotecraft/creatingemotes/custom_pivot_points) for how to set them up in Blockbench and Blender, and [Custom bones](./custom_bones.md) for animating your own model parts with them.
